...
public class InventoryView : UiView
{
    ...
    private void CantUseCurrentSoul()
    {
        ...
        GUIController.Instance.ShowPopUpMessage(popUpInfo, this);
    }
    ...
    {
        GUIController.Instance.UpdateScoreWithEffect(Avatar.rectTransform.position, points);
    }
        ...
        if (active)
        {
            ...
            if (isInCorrectLocalization)
            {
                ...
                PopUpInformation popUpInfo = new PopUpInformation
                {
                    ...
                    UseOneButton = false,
                    Header = "USE ITEM",
                    Message = $"Are you sure you want to USE: {_currentSoulInformation.soulItem.Name} ?. You will receive {points} points.",
                    Confirm_OnClick = UseCurrentSoul
                };
                UseButton.onClick.AddListener(() => GUIController.Instance.ShowPopUpMessage(popUpInfo, this));
            }
            else
            {
    ...
    private void SetupDestroyButton(bool active)
    {
        ...
        if (active)
        {
            ...
            DestroyButton.onClick.AddListener(() => GUIController.Instance.ShowPopUpMessage(popUpInfo, this));
        }
